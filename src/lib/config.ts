 ...
 * ═══════════════════════════════════════════════════════════════════════════════
 * 
 * Project: e2e-test-1777257224381
 * Type: game
 * Category: platformer
 * 
...
export const PROJECT = {
  name: 'e2e-test-1777257224381',
  slug: 'e2e-test-1777257224381',
  description: 'Created with MiniDev ONE Template',
  author: 'MiniDev User',
  version: '1.0.0',
  license: 'GPL-3.0',
  url: 'https://e2e-test-1777257224381.minidev.app',
  repository: 'https://github.com/MiniDevPlatform/e2e-test-1777257224381',
} as const;
...
export const FEATURES = {
  ...
  // Campaign
  campaign: { enabled: false, levels: [], achievements: [], saveProgress: true, saveKey: 'e2e-test-1777257224381_progress' },
